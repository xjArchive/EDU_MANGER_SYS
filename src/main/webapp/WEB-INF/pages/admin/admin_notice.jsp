                ...
                <div class="layui-card-body">
                    ...
                    <div class="test-table-reload-btn" style="margin-bottom: 10px;">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-inline">
                                <input class="layui-input" name="content" id="content" autocomplete="off" placeholder="模糊查询">
                            </div>
                        </div>
                        <div class="layui-inline">
        ...
        <form class="layui-form" id="AddNotice" method="post" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id = "tit" name="title" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
    ...
    layui.use(['element','table','laydate','form','jquery','layer','layedit'], function(){
        ...
        var tableObj = table.render({
            ...
            ,cols: [[
                ...
                ,{field:'createDate', title:'创建日期', width:160, sort: true}
                ,{field:'updateDate', title:'修改日期', width:160, sort: true}
        ...
        table.on('tool(noticeTable)', function(obj) {
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('确定删除该条信息么？',{icon: 3, title:'温馨提示'}, function(index){
                    console.log(data.id)
                    //向服务端发送删除请求
                    $.post("/admin/delNoticeById",{noticeId:data.id},function (res) {
                        console.log(res)
                ...
                layer.open({
                    ...
                    success: function(layero, index){
                        ...
                        form.on('submit(addSubmit)',function (formData) {
                            ...
                            $.post("/admin/UpdateNotice",formData.field,function (res) {
        ...
        $('.search').on('click', function () {
            ...
            table.reload('testReload',{
                method: 'get'
                , url: '/admin/getNoticeByCondition'
                , where: {
                    'title':$('#title').val(),
                    'content':$('#content').val()
                }
            ...
            layer.open({
                ...
                success: function(layero, index){
                    ...
                    form.on('submit(addSubmit)',function (data) {
                        console.log(data)
                        $.post("/admin/AddNotice",data.field,function (res) {
                            console.log("响应"+res.msg)
                            if (res.code == 200){
                                layer.close(index); //关闭弹层
                                layer.msg("添加成功")
