			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
					...
					<li data-name="template" class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd><a lay-href="View/StudentCourse">我的课表</a></dd>
						</dl>
						<dl class="layui-nav-child">
							<dd><a lay-href="View/selectCourse">网上选课</a></dd>
						</dl>
					</li>
					...
					<li data-name="grade" class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd>
								<a lay-href="View/getMyGrade">学生成绩查询</a>
							</dd>
						</dl>
					</li>
					...
					<li data-name="grade" class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd>
								<a lay-href="View/commitTran">提交事务</a>
							</dd>
							<dd>
								<a lay-href="View/myTran">我的事务</a>
							</dd>
							<dd>
								<a lay-href="View/selectView">毕业选题</a>
							</dd>
						</dl>
					</li>
